...
from nipype.interfaces.ants import N4BiasFieldCorrection, ThresholdImage
...
from niworkflows.interfaces.fixes import Registration
...
def init_n4_only_wf(name='n4_only_wf', omp_nthreads=None):
    ...
    thr_brainmask = pe.Node(ThresholdImage(
        dimension=3, th_low=0, inside_value=1,
